...
def win2():
    ...
    text1 = Label(text='ใส่ ลิ้งก์/URL หรือใส่ตัวหนังสือที่ต้องการ',font=100)
    text1.pack()
    ...
    ok =Button(win,text='OK',width=20,height=1,background='gold',foreground='black',font=3,command=on_click)
    ok.pack()
    ...
    save = Button(win,text='Save',width=20,height=1,background='green',foreground='white',font=3,command=save_qr)
    save.pack()
